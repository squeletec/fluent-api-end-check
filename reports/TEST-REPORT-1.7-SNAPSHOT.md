## Fluent API sentence end check. 1.7-SNAPSHOT
#### Test results
Thu, 21 Jun 2018 23:12:42 +0200
...
##### ![PASSED](icons8-passed-18.png) Compilation should fail when immediate end method missing after anonymous class _([since 1.6-SNAPSHOT](TEST-REPORT-1.6-SNAPSHOT.md))_
