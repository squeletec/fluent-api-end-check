## Fluent API sentence end check. 1.21
#### Test results
Wed, 21 Aug 2019 00:43:48 +0200
...
##### ![PASSED](icons8-passed-18.png) Compilation should pass when end method not missing in consumer body _([since 1.19](TEST-REPORT-1.19.md))_
...
##### ![PASSED](icons8-passed-18.png) Compilation should pass when non dsl statement _([since 2.21](TEST-REPORT-2.21.md))_
Compiler source code: [NonDslStatement.java](../src/test/resources/fluent/api/NonDslStatement.java)
...
##### ![PASSED](icons8-passed-18.png) Compilation should fail when end method missing in consumer body _([since 1.19](TEST-REPORT-1.19.md))_
...
##### ![PASSED](icons8-passed-18.png) Compilation should fail when end method missing in lambda in assignment _([since 1.2](TEST-REPORT-1.2.md))_
Compiler source code: [EndMethodMissingInLambdaInAssignment.java](../src/test/resources/fluent/api/EndMethodMissingInLambdaInAssignment.java)
