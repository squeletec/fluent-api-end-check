## Fluent API sentence end check. 1.15
#### Test results
Tue, 11 Dec 2018 20:55:49 +0100
...
##### ![PASSED](icons8-passed-18.png) Compilation should pass when end method not missing in sequence chain _(new in 1.15)_
...
##### ![PASSED](icons8-passed-18.png) Compilation should fail when end method missing in sequence chain _(new in 1.15)_
...
##### ![PASSED](icons8-passed-18.png) Compilation should fail with missing parameters. end method missing in sequence pattern _(new in 1.15)_
