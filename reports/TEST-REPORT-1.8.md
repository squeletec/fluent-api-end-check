## Fluent API sentence end check. 1.8
#### Test results
Tue, 11 Sep 2018 21:23:50 +0200
...
##### ![PASSED](icons8-passed-18.png) Compilation should pass when continue after end method _(new in 1.8)_
...
##### ![PASSED](icons8-passed-18.png) Compilation should pass when end method not missing in consumer expression _(new in 1.8)_
...
##### ![PASSED](icons8-passed-18.png) Compilation should pass when end method missing in function expression _(new in 1.8)_
...
##### ![PASSED](icons8-passed-18.png) Compilation should fail when end method missing in consumer expression _(new in 1.8)_
...
##### ![PASSED](icons8-passed-18.png) Compilation should fail when end method missing in consumer reference _(new in 1.8)_
...
##### ![PASSED](icons8-passed-18.png) Compilation should fail when end method missing in consumer constructor _(new in 1.8)_
