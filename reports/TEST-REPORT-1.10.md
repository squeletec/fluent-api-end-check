## Fluent API sentence end check. 1.10
#### Test results
Fri, 21 Sep 2018 20:57:19 +0200
...
##### ![PASSED](icons8-passed-18.png) End method check file should pass end method check file with unique name _(new in 1.10)_
...
##### ![PASSED](icons8-passed-18.png) End method check file should throw illegal argument exception end method check file with duplicate name _(new in 1.10)_
...
##### ![PASSED](icons8-passed-18.png) End method check file should throw assertion error no end method check file _(new in 1.10)_
